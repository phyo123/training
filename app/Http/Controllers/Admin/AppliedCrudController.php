...
/**
 * Class AppliedCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class AppliedCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Applied::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/applied');
        CRUD::setEntityNameStrings('applied', 'applieds');
    }
    ...
    {
        //CRUD::setValidation(AppliedRequest::class);
