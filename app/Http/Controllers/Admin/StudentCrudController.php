...
use App\Models\ComputerSkillCourse;
...
class StudentCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('skill', 'students');
    }
    ...
    protected function setupListOperation()
    {
        ...
        //echo $routeName; exit;// For debugging purposes, you can remove this later
        // CRUD::column('name')->label('Student Name')->type('text');

        // CRUD::addColumn([
        //     'name' => 'course_name_display', // can be anything, not an actual DB field
        //     'label' => 'Course',
        //     'type' => 'model_function',
        //     'function_name' => 'getCourseNameForList',
        //     'limit' => 255, // optional
        // ]);
    ...
    protected function setupCreateOperation()
    {
        ...
        //$course = ComputerSkillCourse::all();
        //echo $course[0]['name'];exit;
        // CRUD::addField([
        //         'name' => 'course_id',
        //         'label' => 'Course',
        //         'type' => 'select',
        //         'entity' => 'course',
        //         'model' => \App\Models\ComputerSkillCourse::class,
        //         'attribute' => 'name',
        //     ]);
